...
def construct_knowledge_network(input_path=None, output_dir=None):
    """构建知识网络
    ...
    # 设置输出文件路径
    nodes_path = output_dir / 'knowledge_network_nodes.csv'
    edges_path = output_dir / 'knowledge_network_edges.csv'
