...
# 添加标题
cells.append(nbf.v4.new_markdown_cell('''# 基于多层耦合创新网络的关键核心技术识别

本 notebook 实现了基于多层耦合创新网络的关键核心技术识别的完整流程。'''))

# 添加导入和设置
cells.append(nbf.v4.new_code_cell('''# 导入基础依赖
import pandas as pd
import numpy as np
...
# 步骤 1
cells.append(nbf.v4.new_markdown_cell('''## 1. 原始数据清洗
...
# 步骤 2
cells.append(nbf.v4.new_markdown_cell('''## 2. 多层耦合创新网络构建
...
cells.append(nbf.v4.new_code_cell('''# 导入网络构建函数
...
# 步骤 3
cells.append(nbf.v4.new_markdown_cell('''## 3. 网络层权重计算
...
# 步骤 4
cells.append(nbf.v4.new_markdown_cell('''## 4. 节点关键性计算
...
# 步骤 5
cells.append(nbf.v4.new_markdown_cell('''## 5. 节点核心性计算
...
# 步骤 6
cells.append(nbf.v4.new_markdown_cell('''## 6. 指标权重计算
...
# 步骤 7
cells.append(nbf.v4.new_markdown_cell('''## 7. 节点关键核心性计算
